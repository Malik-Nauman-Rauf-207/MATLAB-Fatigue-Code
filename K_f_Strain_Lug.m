function[CS,CSt] = K_f_Strain_Lug(SelectGeometryDropDown_2,Stress_acting,E_2,K_prime,n_prime,Decimal,Applied_Stress_2)
...
case 'Circular Hole'
    a = 36;% mm diameter of hole
    d = 106;% mm width of plate
    K_f = 3*d/(a+d);
